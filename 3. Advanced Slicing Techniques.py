...
# Problem Statement:
# You have a list of daily temperatures for a month, 
# and you'd like to extract specific data from it.

# Task 1: Given the list of temperatures:

# temperatures = [72, 75, 78, 79, 80, 81, 82, 83, 85, 
...
temperatures = [72, 75, 78, 79, 80, 81, 82, 83, 85, 
                86, 87, 88, 89, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106]
secondWeekTemps = temperatures[7:14]
print(secondWeekTemps)

# Task 2: Extract all the temperatures above 100.
hotTemps = []
for temp in temperatures:
    if temp > 100:
        hotTemps.append(temp)
    else:
        pass
print(hotTemps)
